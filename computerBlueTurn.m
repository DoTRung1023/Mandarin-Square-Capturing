function [boxList, citizenList, bluePoint, redPoint, winner] = computerBlueTurn(boxList, citizenList, bluePoint, redPoint, winner)
% initialise variable
loopOfMoving = 10;

% get input
[blueBox, blueDirection] = getComputerBlueMove(boxList, citizenList);
