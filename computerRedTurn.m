function [boxList, citizenList, bluePoint, redPoint, winner] = computerRedTurn(boxList, citizenList, bluePoint, redPoint, winner)
% initialise variable
loopOfMoving = 10;

% get input
[redBox, redDirection] = getComputerRedMove(boxList, citizenList);
