function [boxPosition, direction] = getPlayerRedMove(boxList, citizenList)
% print intro
fprintf("Red turn.\n")
% plot
...
while ~validBox
    boxPosition = input('Enter a red square: ', 's');
            ...
            if boxPosition == boxList(i, :)
                if boxPosition(1) == 'r'
                    if citizenList(i, 1) > 0
                        ...
                        fprintf("Please enter a valid red square with at least one citizen!\n")                                        
                    end
                    break;
                end
            end
            if i == length(boxList)
                fprintf("Please enter a valid red square!\n")                
            end
        end
    else
        fprintf("Please enter a valid red square!\n")
